...
export class CompanyComponent implements OnInit, OnDestroy {
  ...
  constructor(protected companyService: CompanyService, protected dataUtils: JhiDataUtils, protected eventManager: JhiEventManager, protected modalService: NgbModal) {}
